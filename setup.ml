...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7ba34037cd940889d29c8ff81db985ab) *)
(*
...
# 21 "/usr/home/ermine/projects/ocaml/src/oasis.git/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "erm_treap"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://github.com/ermine/treap.git";
                      src_repo_browser =
                        Some "https://github.com/ermine/treap";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "– YÌ\b\021òòXÚ+®\015\006u¦";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
